...
public abstract class ItemPage extends BasePage {
	...
	@FindBy(xpath = "//div[@class = 'productPageAddButton']")
	//@FindBy(xpath = "//a[@id='add2CartBtn']")
	private BaseElement mobileAddToBag;
	...
	public void clickAddToBag() {
		...
		sleep(5000);
		evaluateJavascript("arguments[0].scrollIntoViewIfNeeded();", addToBag);
		addToBag.waitUntilClickable().click();
	}
	public void clickMobileAddToBag() {
		LOGGER.info("Clicking Add to bag in Mobile");
		sleep(5000);
		evaluateJavascript("arguments[0].scrollIntoViewIfNeeded(true);", mobileAddToBag);
		sleep(5000);
		mobileAddToBag.waitUntilClickable().click();
	}
	...
	public void addToMobileWishList() {
		LOGGER.info("Adding item to wishlist...");
		evaluateJavascript("arguments[0].scrollIntoViewIfNeeded();", addToWishlist);
		sleep(sleeptimeout);
		addToWishlist.waitUntilVisible().click();
	}
