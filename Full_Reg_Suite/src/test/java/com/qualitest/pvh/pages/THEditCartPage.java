...
public class THEditCartPage extends EditCartPage {
	
	@FindBy(xpath = "//a[@title='Confirm']")
	...
	public static final Logger LOGGER = LoggerFactory.getLogger(THEditCartPage.class);
