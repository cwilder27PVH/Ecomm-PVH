...
//	@FindBy(xpath = "//*[contains(text('Enter Promo Code')]")
	 ...
	 */
	  ...
	  public void clickOffPopUp() { if (popUpClose.isVisible()) {
	  LOGGER.info("Closing pop up window"); popUpClose.click(); } }
...
//		return 0;
	...
	public void loginWithShoprunner(String email, String password) {
		sleep(3000);
		//Object clickCheckoutWithShopRunner = null;
		//evaluateJavascript("arguments[0].scrollIntoViewIfNeeded();", clickCheckoutWithShopRunner);
		//sleep(10000);
