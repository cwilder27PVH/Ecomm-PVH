...
public class PBWishlistPage extends WishlistPage {
	...
	//MM09082019
	@FindBy(xpath="(//div[@class='button_text primary-button'][contains(text(),'Add To Bag')])[1]")
	private BaseElement addToBagMobile;
	...
	//MM09082019
	public void addFirstItemToMobileCart() {
		LOGGER.info("Adding first item from wishlist to mobile cart...");
		sleep(5000);
		evaluateJavascript("arguments[0].scrollIntoViewIfNeeded(true);", addToBagMobile);
		sleep(3000);
		addToBagMobile.click();
	}
