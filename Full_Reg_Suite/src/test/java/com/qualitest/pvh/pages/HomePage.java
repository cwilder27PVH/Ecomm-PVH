...
public abstract class HomePage extends BasePage {
	...
	protected BaseElement mobilePopUpClose;
...
//	private List<WebElement> searchSuggestionList;
	...
	public void clickOffMobilePopUp() {
		if (mobilePopUpClose.isVisible()) {
			LOGGER.info("Closing Mobile Pop up window");
			//added sleep method here
			sleep(5000);
			mobilePopUpClose.waitUntilClickable().click();
		}
	}
	...
	public void clickMenuButtonMobile() {
		LOGGER.info("Click Mobile Menu Button");
		sleep(3000);
		clickOffMobilePopUp();
		try {
			 menuButton.click();
		} catch (Exception e) {
			LOGGER.info("Mobile Menu Button was not visible so refreshing page");
			sleep(5000);
			pageRefresh();
