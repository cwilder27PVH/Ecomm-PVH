...
//     	  	 pbUser.saveSecondItemInfo();
	...
	public void user_clicks_on_edit_shoppingbag(String code) {
		LOGGER.info("clicking on edit shoping bag to got to cart page...");
		String brand = Serenity.sessionVariableCalled("brand");	
		switch(brand.toUpperCase()) {
	 case "TH":
         thUser.verifyShopRunnereditshoppingbag(code);
         break;
