...
public void user_adds_shipping_and_billing_address_on_mobile(String values) {
	...
	/*
	 * @And("^User updates personal (.*) on mobile four times$") public void
	 * user_updates_personal_info_on_mobile_four_times(String infoFields) {
	 * LOGGER.info("User verifies personal information field error..."); String
	 * brand = Serenity.sessionVariableCalled("brand"); switch (brand.toUpperCase())
	 * { case "CKUS": case "CKCA":
	 * ckUser.editPersonalInformationOnMobileAndSubmitFourTimes(infoFields); break;
	 * case "TH":
	 * thUser.editPersonalInformationOnMobileAndSubmitFourTimes(infoFields); break;
	 * case "SPEEDO":
	 * speedoUser.editPersonalInformationOnMobileAndSubmitFourTimes(infoFields);
	 * break; case "VH": case "IZ": case "SB":
	 * pbUser.editPersonalInformationOnMobileAndSubmitFourTimes(infoFields); break;
	 * default: LOGGER.info("Incorrect Brand: " + brand +
	 * " provided. Expected Brands are: CKUS, CKCA, TH, SPEEDO, VH, IZ, SB"); } }
	 */
