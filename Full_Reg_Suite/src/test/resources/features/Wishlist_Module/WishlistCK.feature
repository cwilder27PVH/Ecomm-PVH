...
#	Given User access <brand> website
    ##MM0821 When User searches for <item>
#	And User clicks on product
#	And User chooses random size
	#MM0821 And User adds the product to their wishlist
	When User searches an <item> with style number and adds it to cart
	Then User verifies adding item from cart to wishlist for guest user
	#MM0821 And User try to login using <email> and <password>
	#MM0821 And User navigates to wishlist
	#MM0821 Then User verifies wishlist item matches item from cart
	#MM0821 And User clear wishlist
