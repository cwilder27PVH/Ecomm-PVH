...
@id=1 @positive @parallel @wishlist_module @brand=TH
...
@id=2 @negative @parallel @wishlist_module @brand=TH
...
@id=3 @positive @parallel @wishlist_module @brand=TH
...
@id=4 @negative @parallel @brand=TH
