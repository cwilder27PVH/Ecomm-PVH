...
#	And User clicks add to bag
	...
	| VH    | VAN5056 | 81902401 			| 1             |
	#| VH    | VAN5056 | H4VH-3491-015 | 1             |
...
Scenario Outline: Add product from wishlist to cart as signed in user
	...
	| VH    | myaccountvh44@gmail.com    | Passw0rd | VAN5056  |   
...
#	And User goes to mobile cart page
	...
	| VH    | VAN5056 | 1        | William | Anish | Happy Birthday! | Anish   | William | Happy day!     |
...
#	Given User access <brand> website
	...
	| VH    | VAN5056 | 1        | ABCDEFG | ABCDEFG is an invalid code |
...
#	Given User access <brand> website
	...
	| VH    | VAN5056  | myaccountvh45@gmail.com  | Passw0rd   | shirt      | 1        |
...
Scenario Outline: Verify sign in users can add products to cart
	...
	| VH    | myaccountvh45@gmail.com | Passw0rd | VAN5056   | 1             | 3              |
...
#	Given User access <brand> website
	...
	| VH    | myaccountvh45@gmail.com   | Passw0rd | VAN5056 | TTTEEE | TTTEEE is an invalid code |
...
#	Given User access <brand> website
	...
	Examples:
	| brand	| email                   | password | item    |
	| VH    | myaccountvh45@gmail.com | Passw0rd | VAN5056 |
