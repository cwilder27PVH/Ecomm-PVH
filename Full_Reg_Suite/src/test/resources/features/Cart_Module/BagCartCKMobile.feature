@module=bagCartCKMobile
Feature: Bag and Cart CK Mobile
Description: This feature uses Bag and Cart to verify 

@id=1 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
@id=3 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	Examples:
	| brand | item     | product   | 
	| CKUS  | 33014357 |  46301423 |
	| CKCA  | 45003293 |  33014357 |
	
@id=4 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
@id=5 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	| CKUS  | 33014357   | 46301423      | 1             |
	| CKCA  | 45003293   | 33014357      | 1             |
	
@id=6 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User chooses random size
	...
	| CKUS  | myaccountckus44@gmail.com  | Passw0rd | 33014357 |
	| CKCA  | myaccountckca44@gmail.com  | Passw0rd | 45003293 |
	
@id=7 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
Scenario Outline: Add product with size and quantity selection then choose to edit product in cart and verify user is navigated to Product Page
	...
	Examples:
	| brand	| item            | quantity | email                     | password |
	| CKUS  | 11008092-400    |  1	     | myaccountckus45@gmail.com | Passw0rd |
	| CKCA  | 11008092-400    |  1		 | myaccountckca45@gmail.com | Passw0rd |
	
#@id=8 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	| CKUS  | 33014357 | 1        | William | Anish | Happy Birthday! |
#	
#@id=9 @positive @parallel @cart_module @brand=CKMobile @mobile
...
#	| CKUS  | ties      | 1        | Anish | Bilal | Happy belated! |
	
@id=10 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	| CKUS  | 33014357 | 1        | William | Anish | Happy Birthday! | Anish   | William | Happy day!     |
	
@id=11 @negative @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	| CKUS  | 33014357 | 1        | ABCDEFG | ABCDEFG is an invalid code |
	| CKCA  | 45003293 | 1        | ABCDEFG | ABCDEFG is an invalid code |
...
@id=15 @negative @parallel @cart_module @cart @brand=CKMobile @mobile
...
@id=16 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#@id=17 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
@id=18 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User clicks add to bag
	...
	| CKUS  | 33014357   | myaccountckus44@gmail.com | Passw0rd | ties       | 1        |
	| CKCA  | 45003293   | myaccountckca44@gmail.com   | Passw0rd | ties     | 1        |
...
#	And User goes to cart page
	...
	| CKUS  | 33014357 | myaccountckus45@gmail.com | Passw0rd | 1             | 3              |
	| CKCA  | 45003293 | myaccountckca45@gmail.com | Passw0rd | 1             | 3              |
...
@id=24 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
@id=28 @negative @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	| CKUS  | myaccountckus45@gmail.com | Passw0rd | 33014357 | TTTEEE | TTTEEE is an invalid code |
	
@id=30 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
...
#	And User goes to cart page
	...
	Examples:
	| brand	| email                     | password | item        |
	| CKUS  | myaccountckus45@gmail.com | Passw0rd | 33014357    |
	| CKCA  | myaccountckca45@gmail.com | Passw0rd | 45003293    |	
	
#@id=31 @positive @parallel @cart_module @cart @brand=CKMobile @mobile
