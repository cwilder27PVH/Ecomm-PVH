@module=loginTHMobile
Feature: Login TH Mobile
	Description: This feature allows user to access account using their registered credentials 

@id=1 @positive @smokeT @prod @registration_login_module @brand=THMobile @mobile
...
@id=2 @negative @registration_login_module @brand=THMobile @mobile
...
@id=4 @positve @registration_login_module @brand=THMobile @mobile
