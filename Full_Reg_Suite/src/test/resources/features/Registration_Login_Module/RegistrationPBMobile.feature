@module=registrationPBMobile
Feature: Registration PB Mobile
Description: This feature allows user to create an account

@id=1 @positive @parallel @registration_login_module @brand=PB @mobile
...
@id=2 @positive @smokeT @prod @parallel @registration_login_module @brand=PB @mobile  @addressy
...
@id=3 @negative @parallel @registration_login_module @brand=PB @mobile  @addressy
...
@id=4 @positive @parallel @registration_login_module @brand=PB @mobile
Scenario Outline: Register with valid details post checkout as Guest User
	...
	| VH     | izo5079      | testingUser@yopmail.com   | 1qaz@WSX | Bobby     | Smith    | 1200 US Highway 22      | 15    | Bridgewater | New Jersey |               | 08807  | 1234567890 |

@id=5 @negative @parallel @registration_login_module @brand=PB @mobile  @addressy
Scenario Outline: Complete Registration when providing invalid address and submitting 3 times
	...
	| VH    | invadd1+vh@yopmail.com   | abcdef123 | Test PVH  | User     | 1200       | 1 		   | Woodbridge  | United States | New Jersey | 08807 | 9085262900 | Male   | January | 12   | United States | New Jersey | Garden State Plaza - 1 Garden State Plaza Way, Paramus, NJ | web           | men  |
	

@id=6 @negative @parallel @registration_login_module @brand=PB @mobile
...
@id=7 @negative @parallel @registration_login_module @brand=PB @mobile
...
@id=8 @negative @parallel @registration_login_module @brand=PB @mobile  @addressy
