@module=loginSPMobile
Feature: Login SP Mobile
	Description: This feature allows user to access account using their registered credentials 

@id=1 @positive @smokeT @prod @parallel @registration_login_module @brand=SPMobile @mobile
...
@id=2 @negative @parallel @registration_login_module @brand=SPMobile @mobile
...
@id=4 @positve @parallel @registration_login_module @brand=SPMobile @mobile
