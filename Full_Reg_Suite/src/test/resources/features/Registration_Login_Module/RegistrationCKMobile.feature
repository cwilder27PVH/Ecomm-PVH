@module=registrationCKMobile
Feature: Registration CK Mobile
Description: This feature allows user to create an account

@id=1 @positive @parallel @registration_login_module @brand=CK @mobile
...
@id=2 @positive @smokeT @prod @parallel @registration_login_module @brand=CK @mobile  @addressy
...
@id=3 @negative @parallel @registration_login_module @brand=CK @mobile  @addressy
...
@id=4 @positive @parallel @registration_login_module @brand=CK @mobile
...
@id=5 @negative @parallel @registration_login_module @brand=CK @mobile  @addressy
...
@id=6 @negative @parallel @registration_login_module @brand=CK @mobile
...
@id=7 @negative @parallel @registration_login_module @brand=CK @mobile
...
@id=8 @negative @parallel @registration_login_module @brand=CK @mobile  @addressy
