@module=registrationSP
Feature: Registration SP
...
@id=2 @positive @smokeT @prod @parallel @registration_login_module @brand=SP @desktop  @addressy
...
@id=3 @negative @parallel @registration_login_module @brand=SP @desktop  @addressy
...
@id=4 @positive @parallel @registration_login_module @brand=SP @desktop
...
@id=8 @negative @parallel @registration_login_module @brand=SP @desktop  @addressy
