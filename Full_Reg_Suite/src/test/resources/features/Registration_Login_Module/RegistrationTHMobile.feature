@module=registrationTHMobile
Feature: Registration TH Mobile
Description: This feature allows user to create an account

@id=1 @positive @parallel @registration_login_module @brand=TH @mobile
...
@id=2 @positive @smokeT @prod @parallel @registration_login_module @brand=TH @mobile  @addressy
...
@id=3 @negative @parallel @registration_login_module @brand=TH @mobile  @addressy
...
@id=4 @positive @parallel @registration_login_module @brand=TH @mobile
...
@id=5 @negative @parallel @registration_login_module @brand=TH @mobile  @addressy
...
@id=6 @negative @parallel @registration_login_module @brand=TH @mobile
...
@id=7 @negative @parallel @registration_login_module @brand=TH @mobile
...
@id=8 @negative @parallel @registration_login_module @brand=TH @mobile  @addressy
