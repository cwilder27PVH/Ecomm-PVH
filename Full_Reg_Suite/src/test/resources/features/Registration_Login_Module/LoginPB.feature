...
@id=1 @positive @smokeT @prod @parallel @registration_login_module @brand=PB @desktop
...
@id=2 @negative @parallel @registration_login_module @brand=PB @desktop
...
@id=4 @positve @parallel @registration_login_module @brand=PB @desktop
