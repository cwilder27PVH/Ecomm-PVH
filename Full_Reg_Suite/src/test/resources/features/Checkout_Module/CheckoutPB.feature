...
@id=1 @positive @parallel @checkout_module @desktop @checkOut @brand=PB @addressy
...
#    Given User access <brand> website
	...
	| VH    | myaccountvh4@gmail.com   | Passw0rd | IZO5079   | myaccountvh4@gmail.com;Bobby;Smith;1200 US Highway 22; ;Bridgewater;New Jersey; ;08807;1234567890 | Test PVH  | User     | 1200 US Highway 22 | 1 | Bridgewater | United States | New Jersey | 08807 | 1234567890 | Male   | 1       | 1    |
...
#	Given User access <brand> website
	...
	| VH    | IZO5079 | chck1speedo@gmail.com;Bobby;Smith;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | chck3+VH@testmail.com;Cindy;Smith;1001 Frontier Road;;Bridgewater;New Jersey; ;08807;9082316660 |
...
#	| VH    | izo5079  | testvh@gmail.com;Bobby;Smith;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | test1@testmail.com;Shaun;Smith;1001 Frontier Road;;Bridgewater;New Jersey; ;08807;9082316660 | test2@testmail.com;Cindy;Smith;1001 Frontier Road;;Bridgewater;New Jersey; ;08807;9082316660 |
...
#	And User cancels the order
	...
	| VH    | IZO5079 	| testing@gmail.com;Anish;Patel;1200 US Highway 22; ;Bridgewater;New Jersey; ;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    |
...
#	And User cancels the order
	...
	Examples:
	| brand | item    | guestFields                                                                                 | type       | number           | code | expMonth | expYear |
	| VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | MasterCard | 5555555555554444 | 456  | 10       | 2020    |
...
#	And User submit order using credit card <type>, <number>, <code>, <expMonth>, <expYear>
	...
	Examples:
	| brand | item    | guestFields                                                                                 | type     | number           | code | expMonth | expYear |
    | VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | Discover | 6011123412331112 | 456  | 10       | 2020    |
...
#	And User submit order using credit card <type>, <number>, <code>, <expMonth>, <expYear>
	...
	Examples:
	| brand | item    | guestFields                                                                                 | type             | number          | code | expMonth | expYear |
	| VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | American Express | 378282246310005 | 4561 | 10       | 2020    | 

@id=11 @positive @parallel @checkout_module @desktop @checkOut @brand=PB
...
#	When User provides <guestFields> into address fields
	...
	| VH    | IZO5079 | Testerpvh1@gmail.com;Anish;Patel;2284 Polk Avenue;;North Brunswick;New Jersey;United States;08902;7323257940 | Testerpvh1@gmail.com | passw0rd | standard       |
...
#    When User provides <guestFields> into address fields
	...
	| VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | 7777127677516507 | 68726267 |
...
#	| VH    | izo5079    | testatech123@gmail.com | password123 |
...
#	| VH    | izo5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | VISA             | 4111111111111111 | 456            | 10                 | 2020               | 7777127677505212 | 68856122    | 5				|
...
#@id=16 @positive @parallel @checkout_module @desktop @checkOut @brand=PB
...
#@id=21 @positive @parallel @checkout_module @desktop @checkOut @brand=PB
...
@id=24 @positive @parallel @checkout_module @desktop @checkOut @brand=PB
...
#	Examples:
#	| brand | email                    | password | item |        
#	| VH    | myaccountVH4@gmail.com   | Passw0rd | izo5079  | 	
...
@id=29 @positive @parallel @checkout_module @desktop @checkOut @brand=PB
...
#    When User provides <addressFields> into address fields
	...
	| VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | chck3+VH@testmail.com;Cindy;Smith;1001 Frontier Road;;Bridgewater;New Jersey; ;08807;9082316660 |
...
#	When User provides <addressFields> into address fields
	...
	| VH    | IZO5079 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;7323257940 | standard       | VISA | 4111111111111111 | 456  | 10       | 2020    | overnight       |
...
#    When User provides <addressFields> into address fields
 ...
 #   And User clicks next
	...
	| VH    | IZO5079  | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | MasterCard  | 5555555555554444 | 456   | 10        | 2020     |
...
#   And User add <item> to cart
	...
	| VH    | myaccountVH44@gmail.com |  Passw0rd | IZO5079 | VISA | 4111111111111111 | 456  | 10       | 2020    | Test PVH  | User     | 1200 US Highway 22 | 1 | Bridgewater | United States | New Jersey | 08807 | 1234567890 | Male   | 1       | 1    | 	
...
#	Then User verify updated product color
	...
	Examples:
	| brand | email                   | password | item     | type | number           | code | expMonth | expYear | firstName | lastName | address    | apartment | city        | country       | state      | zip   | phone      | gender | bMonth  | bDay |       	
	| VH    | myaccountvh43@gmail.com | Passw0rd | IZO5079  | VISA | 4111111111111111 | 456  | 10       | 2020    | Test PVH  | User     | 1200 US Highway 22 | 1 | Bridgewater | United States | New Jersey | 08807 | 1234567890 | Male   | 1       | 1    |  