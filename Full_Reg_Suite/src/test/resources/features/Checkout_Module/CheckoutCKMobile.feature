@module=checkoutCKMobile
Feature: Checkout CK Mobile
	Description: This feature allows user to checkout
	
@id=1 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
@id=2 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
#   Examples:
#	| brand | email                   | password | item                | editAddress                                                                                   | firstName | lastName | address                | apartment | city        | country       | state      | zip     | phone      | gender | bMonth  | bDay | prefCountry   | prefState  | prefStore                                                  | communication | type |
#	| CKCA  | checkoutckca2@gmail.com | Passw0rd | striped sweater men | ckSpeedoTH2@yopmail.com;Cindy;Smith;3932 Richmond Road; ;Calgary;Alberta; ;T2T 0C6;9085262900 | myaccount | ckca6    |  6730 University Drive |           | Lacombe     | Canada        | Alberta    | T4L 2E5 | 7326368321 | Male   |   1     | 1    | Canada        | Alberta    |                                                            |               |      |
	

@id=3 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
@id=4 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
#@id=4 @positive @parallel @checkout_module @mobile
...
@id=5 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
#@id=6 @positive @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
@id=7 @positive @smokeT @parallel @checkout_module @checkOut @brand=CKMobile @addressy @mobile
...
#@id=7 @positive @parallel @checkout_module @mobile
...
@id=8 @positive @smokeT @parallel @checkout_module @checkOut @brand=CKMobile
...
#@id=8 @positive @parallel @checkout_module @mobile
...
@id=9 @positive @smokeT @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=9 @positive @parallel @checkout_module @mobile
...
@id=10 @positive @smokeT @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=10 @positive @parallel @checkout_module @mobile
...
@id=11 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=11 @positive @parallel @checkout_module @mobile
#Scenario Outline: Verify checkout using Paypal
#	Given User access <brand> website
#    And User add <item> to cart
...
@id=12 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#	Examples:
#	| brand | item   | guestFields                                                                                           | number           | pin      |
#	| CKCA  | wallet | testing@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | 7777063816079827 | 42679890 |

#@id=13 @positive @parallel @checkout_module @mobile
...
@id=14 @parallel @positive @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=15 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
Scenario Outline: Checkout using CreditCard and GiftCard
	...
	| CKUS  | jackets | testing@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | VISA             | 4111111111111111 | 456            | 10                 | 2020               | 7777063816087566 | 67910187    |
	| CKUS  | jackets | testing@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | MasterCard       | 5555555555554444 | 456            | 10                 | 2020               | 7777063816087566 | 67910187    |
	| CKUS  | jackets | testing@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | Discover         | 6011123412331112 | 456            | 10                 | 2020               | 7777063816087566 | 67910187    |
	| CKUS  | jackets | testing@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | American Express | 378282246310005  | 4561           | 10                 | 2020               | 7777063816087566 | 67910187    |

@id=16 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
Scenario Outline: Verify checkout using Paypal and GiftCard
	...
	| CKUS  | jacket | Testerpvh1@gmail.com;Anish;Patel;1200 US Highway 22;1;Bridgewater;New Jersey;United States;08807;1234567890 | 7777063816079827 | 42679890 | Testerpvh1@gmail.com | passw0rd |
	
#@id=17 @positive @parallel @checkout_module @mobile
...
#
#@id=19 @positive @parallel @checkout_module @mobile
...
@id=21 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=24 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=25 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=26 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=27 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
#@id=28 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=29 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=30 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=31 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=32 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=33 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
...
@id=34 @positive @parallel @checkout_module @checkOut @brand=CKMobile @mobile
