@module=checkoutSPMobile
Feature: Checkout SP Mobile
	Description: This feature allows user to checkout
	
@id=1 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile @addressy
Scenario Outline: Adding new shipping address during guest checkout
	...
	| SPEEDO | 7750130 | chck1speedo@gmail.com;Bobby;Smith;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | chck3+ckus@testmail.com;Cindy;Smith;1001 Frontier Road;22;Bridgewater;New Jersey; ;08807;9082316660 |
	
@id=2 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile @addressy
Scenario Outline: Editing shipping address during checkout with signed in user
	...
	| SPEEDO | myaccountspeedo43@gmail.com | Passw0rd | 7530331 | ckSpeedoTH2@yopmail.com;Bobby;Smith;1200 US Highway 22; ;Bridgewater;New Jersey; ;08807;1234567890 | myaccount | speedo3  |            |           |      |         |       |     |  7324567890     |        |        |      |             |           |           |               |      |myaccount;speedo3;1200 US Highway 22;15;Bridgewater;New Jersey;08807;7324567890 |

@id=3 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile @addressy
...
@id=4 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile @addressy
...
#	And User cancels the order
	...
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22; ;Bridgewater;New Jersey;United States;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | 
  
@id=8 @positive @smokeT @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#	And User cancels the order
    ...
    Examples:
    | brand  | item    | guestFields                                                                                             | type       | number           | code | expMonth | expYear |
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | MasterCard | 5555555555554444 | 456  | 10       | 2020    | 

@id=9 @positive @smokeT @parallel @checkout_module @checkOut @brand=SPMobile @mobile
Scenario Outline: Checkout using Discover card
    ...
    Examples:
    | brand  | item    | guestFields                                                                                             | type     | number           | code | expMonth | expYear |
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | Discover | 6011123412331112 | 456  | 10       | 2020    | 
       
@id=10 @positive @smokeT @parallel @checkout_module @checkOut @brand=SPMobile @mobile
Scenario Outline: Verify checkout using American Express card
    ...
    Examples:
    | brand  | item    | guestFields                                                                                             | type             | number          | code  | expMonth | expYear |
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | American Express | 378282246310005 | 4561  | 10       | 2020    | 

@id=11 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
Scenario Outline: Verify checkout using Paypal
	...
	| SPEEDO | 7530331 | Testerpvh1@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | Testerpvh1@gmail.com | passw0rd | standard       |

@id=14 @parallel @positive @checkout_module @checkOut @brand=SPMobile @mobile
...
@id=24 @parallel @positive @checkout_module @checkOut @brand=SPMobile @mobile	
	...
	| SPEEDO| myaccountspeedo44@gmail.com | Passw0rd | 7530331 |
		
@id=25 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#@id=26 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#@id=27 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#@id=28 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
@id=29 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
Scenario Outline: Verify adding new shipping address during checkout from review order page
	...
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | chck3+ckus@testmail.com;Cindy;Smith;1001 Frontier Road;22;Bridgewater;New Jersey; ;08807;9082316660 |
    
@id=30 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
Scenario Outline: Verify adding new billing address during checkout from review order page
	...
	| SPEEDO | 7530331   | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey; ;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | chck3+ckus@testmail.com;Cindy;Smith;1001 Frontier Road;22;Bridgewater;New Jersey; ;08807;9082316660 |
    
@id=31 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#	When User provides <guestFields> into address fields
	...
	| SPEEDO | 7530331 | testing@gmail.com;Anish;Patel;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | standard       | VISA | 4111111111111111 | 456  | 10       | 2020    | overnight       |
	
@id=32 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#    And User clicks next
	...
	| SPEEDO | 7530331 | testing@gmail.com;Anish11;Patel11;1200 US Highway 22;;Bridgewater;New Jersey;United States;08807;1234567890 | VISA | 4111111111111111 | 456  | 10       | 2020    | MasterCard | 5555555555554444 | 456   | 10        | 2020     |

@id=33 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
...
#    And User add <item> to cart
	...
	| SPEEDO | myaccountspeedo44@gmail.com | Passw0rd | 7530331  | VISA | 4111111111111111 | 456  | 10       | 2020    | myaccount | speedo3  |            |           |      |         |       |     |  7324567890     |        |        |      |             |           |           |               |      |myaccount;speedo3;1200 US Highway 22;15;Bridgewater;New Jersey;08807;7324567890 |	

@id=34 @positive @parallel @checkout_module @checkOut @brand=SPMobile @mobile
