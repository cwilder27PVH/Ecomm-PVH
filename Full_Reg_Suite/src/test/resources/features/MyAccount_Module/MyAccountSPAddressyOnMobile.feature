@module=myAccountSPAddressyOnMobile
Feature: My Account SP Addressy On Mobile
	Description: This feature allows user to edit account details

@id=1 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=2 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=3 @positive @parallel @myaccount_module @brand=SP @addressy
Scenario Outline: Verify adding new shipping address with valid values
	...
	| SPEEDO | myaccountspeedo443@gmail.com  | Passw0rd  |myaccount;speedo3;1200 US Highway 22;15;Bridgewater;New Jersey;08807;7324567890 |
	
@id=4 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=5 @positive @parallel @myaccount_module @brand=SP @addressy
...
#@id=6 @positive @parallel @myaccount_module @brand=SP
...
@id=7 @positive @parallel @myaccount_module @brand=SP @addressy
...
#@id=8 @positive @parallel @myaccount_module @brand=SP
...
@id=9 @positive @parallel @myaccount_module @brand=SP @addressy
...
#@id=10 @positive @parallel @myaccount_module @brand=SP
...
@id=11 @negative @parallel @myaccount_module @brand=SP
...
@id=12 @positive @parallel @myaccount_module @brand=SP
...
#@id=13 @negative @parallel @myaccount_module @brand=SP
...
#@id=15 @negative @parallel @myaccount_module @brand=SP
...
@id=16 @negative @parallel @myaccount_module @brand=SP
...
@id=17 @negative @parallel @myaccount_module @brand=SP
...
#@id=18 @positive @parallel @myaccount_module @brand=SP
...
@id=19 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=20 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=21 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=22 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=23 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=24 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=25 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=26 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=27 @positive @parallel @myaccount_module @brand=SP @addressy
...
@id=28 @negative @parallel @myaccount_module @brand=SP @addressy
...
@id=29 @negative @parallel @myaccount_module @brand=SP @addressy
...
@id=30 @negative @parallel @myaccount_module @brand=SP
...
@id=31 @negative @parallel @myaccount_module @brand=SP
...
#@id=32 @negative @parallel @myaccount_module @brand=SP
...
#@id=33 @positive @parallel @myaccount_module @brand=SP
...
#@id=34 @negative @parallel @myaccount_module @brand=SP
...
#@id=35 @positive @parallel @myaccount_module @brand=SP
