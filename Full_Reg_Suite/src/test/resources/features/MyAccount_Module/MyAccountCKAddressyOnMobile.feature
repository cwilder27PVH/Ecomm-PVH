@module=myAccountCKAddressyOnMobile
Feature: My Account CK Addressy On Mobile
	Description: This feature allows user to edit account details

@id=1 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=2 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=3 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=4 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
Scenario Outline: Verify adding new billing address with valid values
	Given User access <brand> website
	When User navigate to mobile login page
	And User try to login using <email> and <password>
	And User adds shipping and billing address on mobile with valid <values>
	Then User verifies new address was added
...
@id=5 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=7 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=8 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=9 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=10 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=12 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=15 @negative @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=16 @negative @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=17 @negative @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=18 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
Scenario Outline: Verify updating address with address verification check failling more then 4 times
	Given User access <brand> website
	When User navigate to mobile login page
	And User try to login using <email> and <password>
	And User updates personal <information> on mobile four times
	Then User verifies personal information updated successfully
...
@id=19 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=20 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=21 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=22 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=23 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=24 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=25 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=26 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=27 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=28 @negative @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=29 @negative @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=35 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=36 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
...
@id=37 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
Scenario Outline: Verify adding checkout preference with valid values and selecting Addressy suggestion
	Given User access <brand> website
	When User navigate to mobile login page
	And User try to login using <email> and <password>
	And User navigates to checkout preferences
	And User uses addressy on mobile to edit checkout preferences <information>
	Then User verifies checkout preferences updated 
...
@id=38 @positive @parallel @myaccount_module @brand=CKMobile @mobile @addressy
