@module=myaccountth4Mobile
Feature: My Account TH Mobile
	Description: This feature allows user to edit account details

@id=1 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=2 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=3 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=4 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=5 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=8 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=9 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=10 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=15 @negative @parallel @myaccount_module @brand=THMobile @mobile
Scenario Outline: Verify editing personal information with invalid values
	...
	| TH     | myaccountth47@gmail.com  | Passw0rd |myaccount;th7;1200 US Highway 22;15;~!#@~!@;United States;New Jersey;08807;7324567890   | Did you mean city of Bridgewater ? Please correct the city/town and try again. |
	
@id=16 @negative @parallel @myaccount_module @brand=THMobile @mobile
Scenario Outline: Verify updating blank personal information in required fields
	...
	Examples:
	| brand  | email                       | password |information                                                                                           | error             |
	| TH     | myaccountth417@gmail.com     | Passw0rd |myaccount;th8;1200 US Highway 22;15; ;United States;New Jersey;08807;7324567890;4111111111111111;04;2022  | Did you mean city of Bridgewater ? Please correct the city/town and try again. |
		

@id=17 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=19 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=20 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=26 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=27 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
@id=28 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=29 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=31 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=35 @positive @parallel @myaccount_module @brand=THMobile @mobile
