@module=myAccountSPMobile
Feature: My Account SP Mobile
	Description: This feature allows user to edit account details

@id=1 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=2 @positive @parallel @myaccount_module @brand=SPMobile @mobile
Scenario Outline: Verify adding checkout preference with valid values
	...
	Examples:
	| brand  | email                      | password | information                                                                                                            |
	| SPEEDO | myaccountspeedo443@gmail.com | Passw0rd | myaccount;th3;1200 US Highway 22;15;Bridgewater;United States;New Jersey;08807;6094065792;4111111111111111;04;2022     |
	
@id=3 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=4 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=5 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=6 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=7 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#	Examples:
#	| brand  | email                      | password |information            |
#	| SPEEDO | qualitestmyaccount1@gmail.com  |  Speedo1  |myaccount1;Patel1;1200 US Highway 22;15;Bridgewater;New Jersey;08897;1234569890;4111111111111111;04;2022 |

#@id=8 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=9 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=10 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=11 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=12 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=13 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=15 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=16 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=17 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=18 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=19 @positive @parallel @myaccount_module @brand=SPMobile @mobile
Scenario Outline: Verify updating existing billing address with valid values
	...
	| SPEEDO | myaccountspeedo45@gmail.com | Passw0rd | myaccount;speedo3;1200 US Highway 22; ;Bridgewater;United States;New Jersey;08807;7324567890 | myaccount;speedo3;1200 US Highway 22;15;Bridgewater;United States;New Jersey;08807;7324567890 |
	
@id=20 @positive @parallel @myaccount_module @brand=SPMobile @mobile
Scenario Outline: Verify updating existing shipping and billing address with valid values
	...
	Examples:
	| brand  | email                       | password | values                                                                                       | values2                                                                         |
	| SPEEDO | myaccountspeedo45@gmail.com  | Passw0rd | myaccount;speedo3;1200 US Highway 22; ;Bridgewater;United States;New Jersey;08807;7324567890 | myaccount;speedo4;1200 US Highway 22;15;Bridgewater;New Jersey;08807;7324567890 |

#@id=21 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#	Examples:
#	| brand  | email                      | password | information                                                               |
#	| SPEEDO | testingpvh123@yopmail.com  | 1qaz@WSX | myaccount;Patel;1200 US Highway 22; ;Batboy;United States;New Jersey;08807;7324567890 |	

#@id=22 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#	Examples:
#	| brand  | email                     | password | information                                                             |
#	| SPEEDO | testingpvh123@yopmail.com | 1qaz@WSX | myaccount;Patel;1200 US Highway 22; ;Supi;United States;New Jersey;08807;7324567890 |	

#@id=23 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#	Examples:
#	| brand  | email                     | password | information                                                                 |
#	| SPEEDO | testingpvh123@yopmail.com | 1qaz@WSX | myaccount;Patel;1200 US Highway 22; ;Superman;United States;New Jersey;08807;7324567890 |	

#@id=24 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=25 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=26 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=27 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=28 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=29 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=30 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
@id=31 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=32 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=33 @positive @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=34 @negative @parallel @myaccount_module @brand=SPMobile @mobile
...
#@id=35 @positive @parallel @myaccount_module @brand=SPMobile @mobile
