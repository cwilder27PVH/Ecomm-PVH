@module=myAccountTHAddressyOn
Feature: My Account TH Addressy On
...
@id=1 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=2 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=3 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=4 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=5 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=8 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=9 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=10 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=15 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
#	When User navigate to login page
	...
	| TH     | myaccountth47@gmail.com  | Passw0rd |myaccount;th7;1200 US Highway 22;BOX 15;~!#@~!@;United States;New Jersey;08807;7324567890   |Did you mean city of Bridgewater ? Please correct the city and try again. |
	
@id=16 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
#	When User navigate to login page
	...
	Examples:
	| brand  | email                       | password |information                                                                                           | error             |
	| TH     | myaccountth417@gmail.com    | Passw0rd |myaccount;th8;1200 US Highway 22;15; ;United States;New Jersey;08807;7324567890;4111111111111111;04;2022  | DID YOU MEAN CITY OF BRIDGEWATER ? PLEASE CORRECT THE CITY AND TRY AGAIN. |
		

@id=17 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=19 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=20 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=26 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
#	When User navigate to login page
	...
	Examples:
	| brand | email                   | password | information                                                                    |
	| TH    | myaccountth411@gmail.com | Passw0rd | myaccount;th10;1200 US 22; ;Superman;United States;New Jersey;08807;7324567890 |

@id=27 @positive @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=28 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=29 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
@id=31 @negative @parallel @myaccount_module @brand=TH @desktop  @addressy
...
#	When User navigate to login page
	...
	Examples:
	| brand	| email                        | password |
	| TH    | myaccountth422@gmail.com     | Passw0rd |
...
#    And User add <item> to cart
	...
	@id=36 @positive@myaccount_module @brand=TH  @addressy
...
@id=37 @positive @parallel @myaccount_module @brand=TH  @addressy
...
@id=38 @positive @parallel @myaccount_module @brand=TH  @addressy
