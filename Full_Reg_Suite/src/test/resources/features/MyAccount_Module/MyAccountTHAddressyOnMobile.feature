@module=myaccountth4AddressyOnMobile
Feature: My Account TH Mobile Addressy On
	Description: This feature allows user to edit account details

@id=1 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=2 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=3 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=4 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=5 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=7 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify adding new shipping address with address verification check failure more then 4 times
	...
	Examples:
	| brand  | email                       | password |information                                                                                          |
	| TH     | myaccountth43@gmail.com     | Passw0rd |myaccount1;Patel1;1200 US 22;BOX 15;Bridgewater;New Jersey;08889;1234569890;4111111111111111;04;2022 |
	
@id=8 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=9 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=10 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=11 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=12 @positive @parallel @myaccount_module @brand=THMobile @mobile
...
#	And User submit order using credit card <type>, <number>, <code>, <expMonth>, <expYear>
	...
	| TH    | myaccountth43@gmail.com | Passw0rd | aw04548  | VISA | 4111111111111111 | 456  | 10       | 2020    |
...
@id=15 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=16 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=17 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=18 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify updating address with address verification check failling more then 4 times
	...
	Examples:
	| brand | email                   | password | information                                                                  |
	| TH    | myaccountth48@gmail.com | Passw0rd | myaccount;Patel;1200 US 22;;Camden;United States;New Jersey;08807;7324567890 |
	
@id=19 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
Scenario Outline: Verify updating existing billing address with valid values
	...
	| TH    | myaccountth43@gmail.com | Passw0rd | myaccount;ckca3;1200 US Highway 22; ;Bridgewater;United States;New Jersey;08807;7324567890 | myaccount;th3;1001 Frontier rd;BOX 15;Bridgewater;United States;New Jersey;08807;7324567890 |

@id=20 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
Scenario Outline: Verify updating existing shipping and billing address with valid values
	...
	Examples:
	| brand | email                   | password | values                                                                                   | values2                                                                                |
	| TH    | myaccountth43@gmail.com | Passw0rd | myaccount;th3;1200 US Highway 22; ;Bridgewater;United States;New Jersey;08807;7324567890 | myaccount;th4;1001 Frontier rd;;Bridgewater;United States;New Jersey;08807;7324567890  |
	
@id=21 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify updating existing shipping address with address verification check failure more then 3 times
	...
	| TH    | myaccountth43@gmail.com | Passw0rd | myaccount;Patel;1200 US 22; ;sfgsfd;United States;New Jersey;08807;7324567890 | myaccount;th4;1001 Frontier rd;;Bridgewater;United States;New Jersey;08807;7324567890  |

@id=22 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify updating existing billing address with address verification check failure more then 4 times
	...
	Examples:
	| brand | email                   | password | information                                                                 |  values2                                                                               |
	| TH    | myaccountth45@gmail.com | Passw0rd | myaccount;Patel;1200 US 22; ;Supi;United States;New Jersey;08807;7324567890 | myaccount;th4;1001 Frontier rd;;Bridgewater;United States;New Jersey;08807;7324567890  |
	

@id=23 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify updating existing shipping and billing address with address verification check failure more then 4 times
	...
	Examples:
	| brand | email                   | password | information                                                                     |  values2                                                                               |
	| TH    | myaccountth45@gmail.com | Passw0rd | myaccount;Patel;1200 US 22; ;Superman;United States;New Jersey;08807;7324567890 | myaccount;th4;1001 Frontier rd;;Bridgewater;United States;New Jersey;08807;7324567890  |

@id=24 @positive @parallel @myaccount_module  @addressy
Scenario Outline: Verify adding new billing address with address verification check failure more then 4 times
	...
	Examples:
	| brand | email                   | password | information                                                                     |
	| TH    | myaccountth45@gmail.com | Passw0rd | myaccount;Patel;1200 US 22; ;Superman;United States;New Jersey;08807;7324567890 |
	

@id=25 @positive @parallel @myaccount_module @addressy
...
@id=26 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=27 @positive @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=28 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=29 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=30 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=31 @negative @parallel @myaccount_module @brand=THMobile @mobile  @addressy
...
@id=32 @negative @parallel @myaccount_module @brand=THMobile @mobile
...
@id=33 @positive @parallel @myaccount_module @brand=THMobile @mobile
Scenario Outline: Verify adding a new item to wishlist from cart as signed in user
	...
	| TH    | myaccountth420@gmail.com     | Passw0rd | aw04548 |

@id=34 @negative @parallel @myaccount_module @brand=THMobile @mobile
Scenario Outline: Verify sharing saved items without providing mandatory details
	...
	Examples:
	| brand	 | email                        | password  | item    |
	| TH     | myaccountth425@gmail.com     | Passw0r  | aw04548 |
	
@id=35 @positive @parallel @myaccount_module @brand=THMobile @mobile @addressy
Scenario Outline: Verify sharing saved items with valid details
	...
	| TH     | myaccountth425@gmail.com | Passw0rd | myaccountspeedo3@gmail.com |myaccount  |myaccountspeedo20@gmail.com | Look at this | aw04548 |

	@id=36 @positive @parallel @myaccount_module @brand=TH  @addressy
...
@id=37 @positive @parallel @myaccount_module @brand=TH @brand=THMobile @mobile @addressy
...
@id=38 @positive @parallel @myaccount_module @brand=TH @brand=THMobile @mobile @addressy
