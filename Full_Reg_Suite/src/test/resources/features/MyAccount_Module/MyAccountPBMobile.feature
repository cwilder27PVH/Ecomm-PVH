@module=myAccountPBMobile
Feature: My Account PB Mobile
	Description: This feature allows user to edit account details

@id=1 @positive@myaccount_module @brand=PBMobile @mobile
...
@id=2 @positive @myaccount_module @brand=PBMobile @mobile
Scenario Outline: Verify adding checkout preference with valid values
	...
	Examples:	
	| brand | email                    | password | information   															          				   	             |
	| VH    | myaccountvh443@gmail.com   | Passw0rd | myaccount;vh3;1130 US Highway 22;BOX 15;Bridgewater;United States;New Jersey;08807;6094065555;4111111111111111;04;2022   |

@id=3 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=4 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=5 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=6 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=7 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=8 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=9 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=10 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=11 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=12 @positive @myaccount_module @brand=PBMobile @mobile 
...
# */@id=13 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=15 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=16 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=17 @negative @myaccount_module @brand=PBMobile @mobile 
...
#@id=18 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=19 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=20 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=21 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=22 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=23 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=24 @positive @myaccount_module @brand=PBMobile @mobile 
...
#@id=25 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=26 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=27 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=28 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=29 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=30 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=31 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=32 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=33 @positive @myaccount_module @brand=PBMobile @mobile 
...
@id=34 @negative @myaccount_module @brand=PBMobile @mobile 
...
@id=35 @positive @myaccount_module @brand=PBMobile @mobile 
