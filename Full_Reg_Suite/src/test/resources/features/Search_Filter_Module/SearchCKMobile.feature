@module=searchProductCKMobile
Feature: Search Product CK
...
Scenario Outline: Search products using Style Number 
	...
	Then  User should view mobile <styleNumber> product details
...
#@id=9 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=10 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=11 @negative @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=12 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=13 @negative @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=14 @negative @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=15 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
#@id=16 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=17 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=18 @positive @parallel @search_filter_module @brand=CKMobile @mobile
...
@id=19 @positive @parallel @search_filter_module @brand=CKMobile @mobile
