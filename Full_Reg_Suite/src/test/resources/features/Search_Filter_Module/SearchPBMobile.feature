@module=searchProductPBMobile
Feature: Search Product PB
	Description: This feature uses search bar to verify search results

@id=1 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=2 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=3 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
Scenario Outline: Search products using words with spaces 
	Given  User access <brand> website 
	When  User searches on mobile with keyword as <usingspaces> 
...
@id=4 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=5 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=6 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=7 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=8 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
Scenario Outline: Verify if search criteria correction is displayed 
	Given  User access <brand> website
	When  User searches on mobile with keyword as <search>
...
@id=9 @negative @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=10 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
Scenario Outline: Search products using valid special characters 
	Given  User access <brand> website 
	When  User searches on mobile with keyword as <specialchar> 
...
@id=11 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=12 @negative @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=13 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=14 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
@id=15 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
#@id=16 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
#@id=14 @negative @parallel @search_filter_module @brand=PBMobileMobile @mobile
...
#@id=9 @positive @parallel @search_filter_module @brand=PBMobileMobile @mobile
